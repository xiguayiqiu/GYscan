...
func detectMiddlewareVulnerabilities() []Vulnerability {
...
func detectWebServerVulnerabilities() []Vulnerability {
...
func detectDatabaseVulnerabilities() []Vulnerability {
	return []Vulnerability{
		{
			ID:          "DB-001",
			Name:        "MySQL权限提升漏洞",
...
func detectApplicationServerVulnerabilities() []Vulnerability {
	return []Vulnerability{
		{
			ID:          "APP-001",
			Name:        "WebLogic反序列化漏洞",
