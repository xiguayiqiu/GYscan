...
func NewReportGenerator(result *types.ScanResult) *ReportGenerator {
...
func (rg *ReportGenerator) sortVulnerabilitiesBySeverity() []types.Vulnerability {
	sorted := make([]types.Vulnerability, len(rg.Result.Vulnerabilities))
