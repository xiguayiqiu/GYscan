...
// Scan 扫描命令执行漏洞
func (ces *CommandExecScanner) Scan(target string, services []types.ServiceInfo) []types.Vulnerability {
...
func (ces *CommandExecScanner) scanWebCommandExec(target string, services []types.ServiceInfo) []types.Vulnerability {
	var vulnerabilities []types.Vulnerability
...
func (ces *CommandExecScanner) scanSystemCommandExec(services []types.ServiceInfo) []types.Vulnerability {
	var vulnerabilities []types.Vulnerability
